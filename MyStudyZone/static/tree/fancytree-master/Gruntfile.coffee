...
#                "src/jquery.fancytree.fixed.js"
    ...
    exec:
        ...
        upload:
            ...
            cmd: "pyftpsync upload . ftp://www.wwwendt.de/tech/fancytree --top_loading_progress --exclude build,node_modules,.*,_* --delete-unmatched"
        upload_force:
            # FTP upload the demo files (requires https://github.com/mar10/pyftpsync)
            cmd: "pyftpsync upload . ftp://www.wwwendt.de/tech/fancytree --top_loading_progress --exclude build,node_modules,.*,_* --delete-unmatched --resolve=local --force"
