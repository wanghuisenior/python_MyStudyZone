...
print(now())
# 将日期对象格式化为字符串
print(datetime_to_str(now(), FORMAT_DATE))
# 将日期字符串按照格式解析为datetime对象,包含时间
print(str_to_datetime('2019-01-02 14:23:47', FORMAT_DATETIME))
# 将日期字符串解析为datetime对象,默认只保留日期
print(type(str_to_date('2019-01-02')), str_to_date('2019-01-02'))
print(get_today())
...
# print(get_utc_time())
print(is_today(now()))
print(is_tomorrow(now()))
# print(add_month(now(),2))
